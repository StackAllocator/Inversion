...
void load_textures() {
  ...
  textures["tileset_1"] = LoadTexture("./Assets/Sprites/Tiles-and-Enemies.png");
  textures["tileset_2"] = LoadTexture("./Assets/Sprites/tileset.png");
}
// ----------------------------------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------------------------------
void load_sounds() {
  sounds["jump"] = LoadSound("./Assets/Sound/jump_07.wav");
